...
struct ContentView: View {
    ...
    var body: some View {
            VStack{
                VStack(spacing: 15) {
                    DisclosureGroup("Annonce, informations", isExpanded: $isExpanded1) {
                        if isExpanded1 {
                            VStack(alignment: .leading) {
                                Text("iStuces s'engage : Fuseaux est et sera toujours gratuit et open-source.\n\n\nMaîtrisez le décalage horaire ! Fuseaux affiche l'heure de chaque endroit du monde, et vous permet de modifier votre configuration horaire. Pour plus d'informations sur son fonctionnement, consultez son répertoire GitHub : https://github.com/istucesyt/Fuseaux\n\nVous utilisez la version 3.0 (beta) de Fuseaux.\n2023, iStuces.")
                    ...
                    if let selectedTimeZone = selectedTimeZone {
                        ...
                        DisclosureGroup("Options", isExpanded: $isExpanded3) {
                            if isExpanded3 {
                                VStack {
                                    Spacer()
                        ...
                        VStack{
                            Text("Aucun fuseau horaire n'est sélectionné...\nPour commencer, veuillez sélectionner un fuseau horaire.")
