    ...
    var body: some View {
            VStack{
                ...
                VStack(spacing: 15) {
                    VStack{
                        VStack{
                            Text("Bienvenue dans Fuseaux.\nFuseaux est et sera toujours gratuit.\nPour plus d'informations, consultez le menu Informations, situé en bas de page.")
